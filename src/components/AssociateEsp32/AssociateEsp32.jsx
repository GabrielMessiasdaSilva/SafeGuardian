      ...
      {isProfileComplete ? (
        <View style={styles.item}>
          ...
          {dispositivos.some(d => d.userID === currentUser.id) ? (
            ...
            <>
              <Text style={styles.itemTextAlerta}>
                Nenhum dispositivo associado. Associe um para iniciar o monitoramento.
              </Text>
              <TouchableOpacity
        ...
        <View style={styles.item}>
          <Text style={styles.loadingText}>
            ⚠️ Realize o cadastro completo na página Perfil para associar um dispositivo.
          </Text>
        </View>
      )}
      <Modal
          ...
          <View style={styles.modalContent}>
            ...
            {dispositivosNaoAssociados.length > 0 ? (
              <FlatList
                ...
                renderItem={({ item }) => (
                  <TouchableOpacity
                    ...
                    onPress={() => associarDispositivo(item.id)}
                  >
              ...
              <Text style={styles.modalText}>
                Nenhum dispositivo disponível. Verifique se estão ligados.
              </Text>
            )}
            <Button
              title="Fechar"
